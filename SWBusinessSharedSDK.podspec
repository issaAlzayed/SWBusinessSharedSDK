...
Pod::Spec.new do |spec|
  ...
  spec.homepage     = 'https://github.com/issaAlzayed/SWBusinessSharedSDK'
  spec.license      = { :type => 'MIT', :file => 'LICENSE' }
  spec.author       = { "Issa Alzayed" => "issa.alzayed@neo.ae" }
  
  spec.source = { :git => "https://github.com/issaAlzayed/SWBusinessSharedSDK.git", :tag => spec.version.to_s, }
